...
const Top = () => {
  ...
  return (
    <div className='mt-23 md:mt-8.5 ml-4 md:ml-7.5 flex flex-col md:flex-row gap-4 md:gap-0 items-start'>
      <h1 className='font-bold text-2xl leading-[100%] text-black'>Invoice List</h1>
      <div className='flex items-center gap-5 md:ml-[666px]'>
        <div className='flex items-center md:w-[230px] h-[40px] bg-white rounded-[10px] px-4 shadow-sm'>
          <input
            type="text"
            placeholder='Search'
