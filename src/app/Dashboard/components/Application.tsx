...
const Application = () => {
  ...
  return (
    <div className='my-7.5  mx-7.5 flex gap-7.5 items-center justify-start' style={{fontFamily:"Nunito"}}>
        {
            stats.map((stats,id)=>(
                <div key={id} className='w-[268px] h-[116px] rounded-[10px] bg-white flex gap-[23px] items-center justify-center'>
