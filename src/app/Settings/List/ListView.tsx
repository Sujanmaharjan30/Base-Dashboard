...
const ListView = () => {
  ...
  return (
    <div>
      ...
      <div className='mt-6.5 w-full md:w-[1162px] bg-white rounded-[15px] ' style={{ fontFamily: "Nunito" }}>
        <div className='flex  items-start mx-7.5 pt-7.5'>
          <h2 className='text-[#030229] text-base leading-[100%] font-semibold'>To Do</h2>
