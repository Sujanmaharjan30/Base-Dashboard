...
const MonthView = () => {
  ...
  return (
    <div className='w-full  md:w-[860px] mx-4 md:mx-0' style={{ fontFamily: "Nunito" }}>
      {/* Header */}
      <div className='flex items-center justify-between mb-4 md:mb-6 bg-white h-[50px] px-6 rounded-tl-[10px] rounded-tr-[10px]'>
      ...
      <div className='overflow-x-auto no-scrollbar rounded-b-[10px] bg-white'>
