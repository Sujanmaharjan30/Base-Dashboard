...
const YearView = () => {
  ...
  return (
    <div className='bg-white rounded-[10px] p-8 w-[860px]' style={{ fontFamily: "Nunito" }}>
      {/* Year Header */}
      <div className='mb-8'>
            ...
            <div key={monthIndex} className='border border-gray-200 rounded-lg p-4'>
              ...
              <div className='grid grid-cols-7 gap-1'>
                {monthDays.map((item, index) => (
                  <div
                    key={index}
                    className={`text-center text-xs py-2 flex items-center justify-center w-8 h-8 rounded-full transition-all ${
                      item.isToday
